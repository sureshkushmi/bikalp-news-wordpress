          ...
          <div id="tie-block_979" class="mag-box big-post-left-box has-first-big-post">
            <div class="container-wrapper">
              ...
              <div class="mag-box-title the-global-title">
                <h3><?php echo esc_html( get_cat_name( get_category_by_slug('अन्नपुर्ण-गाउँपालिका')->term_id ) ); ?></h3>
              </div>
              ...
              <div class="mag-box-container clearfix">
                <ul class="posts-items posts-list-container">
                  ...
                  <?php
                  $args = array(
                    'category_name' => 'अन्नपुर्ण-गाउँपालिका',
                    'posts_per_page' => 5,
                  );
                    ...
                    <div class="theiaStickySidebar">
                        <div class="container-wrapper widget posts-list">
                            <div class="widget-title the-global-title">
                                <div class="the-subtitle">विचार</div>
                            </div>
                            ...
                            <div class="posts-list-big-first has-first-big-post">
                                ...
                                $sidebar_args = array(
                                    'category_name'  => 'विचार',
                                    'posts_per_page' => 2, // Show more if needed
                                );
